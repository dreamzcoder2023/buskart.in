(function ($) {
  ...
  // Date Picker
  if ($(".taxiz-datepicker").length) {
    $(".taxiz-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accordion
  if ($(".taxiz-accordion").length) {
    var accordionGrp = $(".taxiz-accordion");
  ...
  function thmOwlInit() {
    // owl slider
    let taxizowlCarousel = $(".taxiz-owl__carousel");
    if (taxizowlCarousel.length) {
      taxizowlCarousel.each(function () {
        let elm = $(this);
    ...
    let taxizowlCarouselNav = $(".taxiz-owl__carousel--custom-nav");
    if (taxizowlCarouselNav.length) {
      taxizowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let taxizowlCarouselWithCounter = $(
      ".taxiz-owl__carousel--with-counter"
    );
    if (taxizowlCarouselWithCounter.length) {
      taxizowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="taxiz-owl__carousel__counter"><span class="taxiz-owl__carousel__counter__total"></span> <span class="taxiz-owl__carousel__counter__current"></span></div>'
            );
            elm
              .find(".taxiz-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".taxiz-owl__carousel__counter__total")
  ...
  //Strech Column
  function taxiz_stretch() {
    var i = $(window).width();
    $(".row .taxiz-stretch-element-inside-column").each(function () {
      var $this = $(this),
