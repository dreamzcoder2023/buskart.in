...
Route::post('company/login', 'TokenAuthController@company_login');
...
Route::group(['middleware' => 'jwt.verify'], function () {
	...
	//company dashboard 
	 ...
	 Route::get('company/car_details/{id}',[CompanyController::class,'car_details'])->name('company.car_details');
	 Route::get('company/driver_details/{id}',[CompanyController::class,'driver_details'])->name('company.driver_details');
});
