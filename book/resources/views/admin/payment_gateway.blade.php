			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<!-- Stripe Section End -->
						...
						<!-- Paytm Section Start -->
						<div class="box-body">
							<div class="form-group" ng-init="paytm_enabled={{ old('paytm_enabled',payment_gateway('is_enabled','Paytm')) }}">
						...
						<div class="box-body" ng-init="razorpay_enabled={{ old('razorpay_enabled',payment_gateway('is_enabled','Razorpay')) }}">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									...
									<span class="text-danger">{{ $errors->first('razorpay_publish_key') }}</span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									...
									<span class="text-danger">{{ $errors->first('razorpay_secret_key') }}</span>
								</div>
							</div>
						 ...
						 <div class="box-body" ng-init="flutterwave_enabled={{ old('flutterwave_enabled',payment_gateway('is_enabled','Flutterwave')) }}">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									...
									<span class="text-danger">{{ $errors->first('flutterwave_enabled') }}</span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									...
									<span class="text-danger">{{ $errors->first('flutterwave_publish_key') }}</span>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									...
									<span class="text-danger">{{ $errors->first('flutterwave_hash_key') }}</span>
								</div>
							</div>
