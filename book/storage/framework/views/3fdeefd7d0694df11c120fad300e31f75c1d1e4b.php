<div class="container mar-zero" style="padding:0px;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  height--full dash-panel">
        <div class="height--full pull-left separated--sides full-width">
                ...
                <ul class="site-nav">
                    <li class="soft--ends">
                        ...
                        <div class="text--center">
                            ...
                            <div style="font-size: 15px;color: #303841;font-weight: bold;line-height: 58px;"><?php echo e(@Auth::user()->first_name); ?> <?php echo e(@Auth::user()->last_name); ?></div>
            ...
            </div><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/common/driver_dashboard_side_menu.blade.php ENDPATH**/ ?>