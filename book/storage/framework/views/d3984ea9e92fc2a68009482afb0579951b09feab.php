...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 flexbox__item four-fifths page-content" style="padding:0px;">
	<div class="page-lead separated--bottom  text--center text--uppercase"><h1 class="flush-h1 flush"><?php echo e(trans('messages.profile.your_trip')); ?></h1>
	...
	<div class="page-lead separated--bottom  text--center">
		<a href="<?php echo e(url('driver_invoice/'.$trip->id)); ?>" style="padding: 0px 15px 0px 0px !important;font-size: 14px !important;" type="submit" class="btn btn--primary btn-blue"><span style="padding: 7px;" class="icon icon_download"></span>
			<?php echo app('translator')->get('messages.profile.dwnld_invoice'); ?>
		</a>
		</div>
		<div class="trip-details__breakdown">
			<div class="">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 palm-one-whole soft--bottom" ng-cloak>
					<h2 class="text--center text--uppercase" style="font-size: 17px; font-weight: 600;"><?php echo e(trans('messages.profile.fare_break')); ?></h2>
						...
						<tbody>
							<tr class="hard"><td>
								<div class="img--circle img--bordered img--shadow driver-avatar">
									<img src="<?php echo e($trip->rider_thumb_image); ?>">
								</div>
							</td>
							<td class="text--center beta"  id="pad-30" style="font-size: 18px !important;"><?php echo e(trans('messages.profile.you_rode')); ?> <?php echo e($trip->rider_name); ?></td>
						</tr>
					</tbody>
				</table>
			</div>
...
<?php echo $__env->make('template_driver_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/driver_dashboard/driver_trip_detail.blade.php ENDPATH**/ ?>