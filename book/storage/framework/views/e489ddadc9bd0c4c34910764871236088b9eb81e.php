					...
					<!-- Stripe Section End -->
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('paytm_mode', array('local' => 'Sandbox', 'live' => 'Live'), old('paytm_mode',payment_gateway('mode','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_mode']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_id', old('paytm_id',payment_gateway('merchant_id','Paytm')), ['class' => 'form-control', 'id' => 'input_paytm_id', 'placeholder' => 'paytm merchant Id']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_key', old('paytm_key',payment_gateway('key','Paytm')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'paytm key']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_website', old('paytm_website',payment_gateway('website','Paytm')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'paytm merchant website']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_channel', old('paytm_channel',payment_gateway('channel','Paytm')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'paytm merchant channel']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paytm_type', old('paytm_type',payment_gateway('type','Paytm')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'paytm industry type']); ?>
						...
						<div class="box-body" ng-init="razorpay_enabled=<?php echo e(old('razorpay_enabled',payment_gateway('is_enabled','Razorpay'))); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('razorpay_publish_key', old('razorpay_publish_key',payment_gateway('key','Razorpay')), ['class' => 'form-control', 'id' => 'input_razorpay_publish_key', 'placeholder' => 'Razorpay Key']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('razorpay_secret_key', old('razorpay_secret_key',payment_gateway('secret','Razorpay')), ['class' => 'form-control', 'id' => 'input_razorpay_secret_key', 'placeholder' => 'Razorpay Secret']); ?>
					 ...
					 <!-- Razory Pay Section End -->
						 ...
						 <div class="box-body" ng-init="flutterwave_enabled=<?php echo e(old('flutterwave_enabled',payment_gateway('is_enabled','Flutterwave'))); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_publish_key', old('flutterwave_publish_key',payment_gateway('key','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_publish_key', 'placeholder' => 'Flutterwave Key']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_secret_key', old('flutterwave_secret_key',payment_gateway('secret','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_secret_key', 'placeholder' => 'Flutterwave Secret']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('flutterwave_hash_key', old('flutterwave_hash_key',payment_gateway('hash','Flutterwave')), ['class' => 'form-control', 'id' => 'input_flutterwave_hash_key', 'placeholder' => 'Flutterwave Hash']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/payment_gateway.blade.php ENDPATH**/ ?>