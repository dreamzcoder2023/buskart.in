    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo Form::open(['url'=>'admin/add_company', 'class'=>'form-horizontal', 'files'=>true, 'id'=>'company_form']); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::text('vat_number', '', ['class' => 'form-control', 'id' => 'input_vat_number', 'placeholder' => 'VAT Number']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                ...
                <?php echo Form::select('country_code', $country_code_option, '', ['class' => 'form-control', 'id' => 'input_country_code', 'placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive', 'Pending' => 'Pending'), '', ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::text('address_line','', ['class' => 'form-control', 'id' => 'address_line', 'placeholder' => 'Address Line']); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7 col-sm-offset-1">
              <div class="input-group"> 
                <?php echo Form::text('company_commission', 0, ['class' => 'form-control', 'id' => 'input_service_fee', 'placeholder' => 'Company Commission']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/company/add.blade.php ENDPATH**/ ?>