    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo Form::open(['url' => 'admin/edit_app_version/'.$result->id, 'class' => 'form-horizontal form']); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::text('version', $result->version, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Version']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('device_type', array('1' => 'Apple','2' => 'Android'), $result->device_type, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('user_type', array('0' => 'Rider', '1' => 'Driver'), $result->user_type, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('force_update', array('1' => 'Yes','0' => 'No'), $result->force_update, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/admin/resources/views/admin/app_version/edit.blade.php ENDPATH**/ ?>