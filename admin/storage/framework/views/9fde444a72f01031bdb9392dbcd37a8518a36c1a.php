				...
				<div class="box box-info">
					...
					<!--	<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label">Pay to admin Driver Limit (Fixed Amount)</i><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('driver_payout_limit', old('driver_payout_limit',site_settings('driver_payout_limit')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => 'Driver Request Limit']); ?>

								<span class="text-danger"><?php echo e($errors->first('driver_payout_limit')); ?></span>
							</div>
						</div>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/admin/resources/views/admin/site_settings.blade.php ENDPATH**/ ?>