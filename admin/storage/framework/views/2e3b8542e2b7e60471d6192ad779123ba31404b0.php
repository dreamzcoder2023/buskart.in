      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo Form::open(['url' => 'admin/edit_currency/'.$result->id, 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('code', $result->code, ['class' => 'form-control', 'id' => 'input_code', 'placeholder' => 'Code']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('symbol', $result->symbol, ['class' => 'form-control', 'id' => 'input_symbol', 'placeholder' => 'Symbol']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('rate', $result->rate, ['class' => 'form-control', 'id' => 'input_rate', 'placeholder' => 'Rate']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/currency/edit.blade.php ENDPATH**/ ?>