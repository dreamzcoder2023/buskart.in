		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
						<br/>
						<input type="hidden" value="<?php echo e($driver_id); ?>" id="driver_id">
						<div class="box-header" style="height: 54px;">
							<!-- <h3 class="box-title"><?php echo e($count_text); ?></h3> -->
						</div>
						<div class="box-header">
							<div class="row">
								<div class="col-lg-3 col-xs-6">
									<div class="small-box">
										<div class="inner">
											<h3><?php echo e($overall_earning); ?></h3>
								...
								<div class="col-lg-3 col-xs-6">
									<div class="small-box ">
										<div class="inner">
											<h3><?php echo e($overall_commission); ?></h3>
								...
								<div class="col-lg-3 col-xs-6">
									<div class="small-box">
										<div class="inner">
											<h3><?php echo e($overall_rides); ?></h3>
											<p>Completed Rides</p>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-xs-6">
									<div class="small-box">
										<div class="inner">
											<h3><?php echo e($cancelled_rides); ?></h3>
											<p>Cancelled Rides</p>
										</div>
									</div>
								</div>
...
<script>
	app.controller('statements', function($scope, $http) {
		...
		$scope.getStatmentData = function(pageNumber = 1) {
			$scope.isLoading = true;
			let url = '<?php echo e(url(LOGIN_USER_TYPE."/driver_statement")); ?>';
			let data = {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/statements/driver_statement.blade.php ENDPATH**/ ?>