			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="input_license_back" class="col-sm-3 control-label">Vehicle Map app icon<em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::file('app_image',  ['class' => 'form-control', 'id' => 'rc', 'accept' => 'image/*']); ?>

								<span class="text-danger"><?php echo e($errors->first('app_image')); ?></span>
								<img src="<?php echo e($result->app_image); ?>" style="width: auto;height: 100px;padding-top: 10px;" >
							</div>
						</div
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/vehicle_type/edit.blade.php ENDPATH**/ ?>