      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo Form::open(['url' => 'admin/add_help', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::select('category_id', $category->pluck('name', 'id'), '', ['class' => 'form-control', 'id' => 'input_category_id', 'placeholder' => 'Select', 'ng-change' => 'change_category(category_id)', 'ng-model' => 'category_id']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('question', '', ['class' => 'form-control', 'id' => 'input_question', 'placeholder' => 'Question']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    ...
                    <textarea id="answer" name="answer" hidden="true"><?php echo e(old('answer')); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::radio('suggested', 'yes', ''); ?> Yes
                    <?php echo Form::radio('suggested', 'no', true); ?> No
                    <span class="text-danger"><?php echo e($errors->first('suggested')); ?></span>
                  </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/help/add.blade.php ENDPATH**/ ?>