    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <?php echo Form::open(['url' => LOGIN_USER_TYPE.'/edit-vehicle_model/'.$result->id, 'class' => 'form-horizontal','files' => true]); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::text('model_name', $result->model_name, ['class' => 'form-control', 'id' => 'input_make_name', 'placeholder' => 'Vehicle Model Name']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/vehicle_model/edit.blade.php ENDPATH**/ ?>