			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="input_active_image" class="col-sm-3 control-label">Vehicle Map app icon<em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::file('app_image', ['class' => 'form-control', 'id' => 'input_app_image', 'accept' => 'image/*']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536447607/domains/buskart.in/public_html/book/resources/views/admin/vehicle_type/add.blade.php ENDPATH**/ ?>